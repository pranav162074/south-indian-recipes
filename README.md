...
- Card-style grid of famous South Indian dishes
...
script.js → Interactive behavior (showing recipe detail view)
...
1. Clone the repo:
   ...
   ```bash
   git clone https://github.com/pranav162074/south-indian-recipes.git
2. Open index.html in your web browser.

🧑‍💻 Author
pranav162074 on GitHub
